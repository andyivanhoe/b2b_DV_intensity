function attach_callbacks(controls)
    ...
    set(controls.hsetbotbut, 'Callback', {@on_bottom_but_press, [], controls});
    set(controls.hradiogroup, 'SelectionChangeFcn', ...
        {@on_z_slice_selection_changed, [], controls});
    set(controls.hplacebox, 'Callback', ...
        {@on_placebox_but_press, [], controls});
...
%         {@on_next_button_press, [], controls});
    ...
    set(controls.hcalculate, 'Callback', ...
        {on_calculate_button_press, [], controls});
